...
- # Class 1
  collapsed:: true
	...
	- Personality คือบุคลิกภาพ ประกอบด้วย รูปร่าง หน้าตา **ลักษณะภายนอก** *อะไรก็ได้ที่สังเกตุได้จากภายนอก* รวมไปถึงกริยาท่าทาง และ**ลักษณะภายใน** เช่น นิสัย ทิศนคติ แรงจูงใจ มีความเป็นเอกลักษณ์ต่อปัจเจกบุคคล โดยจะต้องมีของ 2 อย่าง คือ
	...
	- สิ่งที่จะหล่อหลอมบุคลิกภาพ
		...
		- สิ้งที่ทำให้มนุษย์แตกต่างกัน
			...
			- ความสนใจ คติ สติปัญญา
				- ด้านความสนใจ
					- สนใจอะไร การจับจุด การสังเกตุ การแสดงออกมาเมื่อได้ Interact กับสิ่งที่สนใจ
				- ด้านเจตคติ
...
- # Class 2
  collapsed:: true
	- ทฤษฎีจิตวิทยาเพื่อวิเคราะห์ตนเอง
		- การวิเคราะห์ตนเอง
					...
					- แบบทดสอบมาตรฐาน
						...
						- แบบทดสอบเชิงปรนัย (Objective Test : เช่น 16PS เป็นต้น)
							- ให้ทำ Self-Report (รายงานตนเอง) ประกอบด้วยชุดคำถามที่แตกต่างกัน
								...
								- **CPI** แบบทดสอบพัฒนามาจาก MMPI แต่ใช้วัดกับ*คนปกติ*
								- **Neo-FFI** วัดบุคลิกภาพ 5 องค์ประกอบ
					- สิ่งที่ควรคำนึง
						- **ผลบวกลวง (False Positive)** : ความจริงคือปกติ ทั้งๆ ที่ผลออกมาว่าคุณผิดปกติ
						- **ผลลบลวง (False Negative)** : ความจริงคือผิดปกติ ทั้งๆ ที่ผลออกมาว่าคุณปกติ
			...
			- โรคจิต (Psychoses)
			  background-color:: yellow
				...
				- มีสาเหตุมาจากความบกพร้องของร่างกาย/สมอง
				  background-color:: blue
					- เกิดมาจากการดื่ม**สุรา**
					- สมองเสื่อมจาก**สารเสพติด**
					- โรคสมองเสื่อมใน**วัยชรา**
...
- # Class 5
	...
	- ความเครียดไม่ใช่นามธรรม และ**ต้องจับต้องได้** บอกได้ว่าใครเกิดความเครียด เป็นสภาวะทางชีวิภาพที่มีไว้เพื่อตอบสนองสิ่งอื่นๆ และถือว่าเป็นเรื่องปกติทั่วไปของมนุษย์ มีทั้งคุณและก็โทษ ขึ้นอยู่กับวิธีตอบสนองของบุคคลนั้นๆ
		- อาการ
			- ร่างกาย
				- ความดันโลหิตสูง ความดัน นอนไม่หลับ ปวดหัว อาหารไม่ย่อย อาจ**คุกคามถึชีวิต**
			- อารมณ์
				- ฉุนเฉียวง่าย ไม่มีสมาธิ ซึมเศร้า ก้าวร้าว ไม่สนโลก ไม่เข้าสังคม ตัดสินใจอะไรไม่ได้ ไม่เห็นคุณค่าในตัวเอง
			- พฤติกรรม
				- ใช้จ่ายเกินควร กินเหล้า สูบบุหรี่ ระบายอารมณ์ด้วยความรุนแรง ใช้สารเสพติด
		- สาเหตุ
			- ความขัดข้องใจ
			- ความขัดแย้งในใจ
			- ความกดดัน
			- การเปลี่ยนแปลงตามพัฒนาการของวัย
...
- ## การแสดงออกที่เหมาะสม
	...
	- เต้ย จะพูดจาเสียงดังในสาธารณะ เพื่อต้องการให้ผู้อื่นเข้าใจ
		...
		-
		-
	- แต้ว ไม่เคยปฏิเสธคำขอ
		- ก้าวร้าว
		- เหมาะสม
		- **ไม่กล้าแสดงออก**
		- แอปแฝง
	- นิว พูดเตือนคนอื่นในพุดเบาๆ ในห้องสมุด เพราต้องการสมาธิ
		- ก้าวร้าว
		- **เหมาะสม**
		- ไม่กล้าแสดงออก
		- แอบแฝง
	- ข้อใด เป็นการก้าวร้าวทางอ้อม
		- น้ำ กล่าวโทษว่า เพราะเธอที่ทำให้ฉันต้องขาดเรียน
		- **จูเน่ จับกลุ่มคุยว่า อันนาใช้แต่ของราคาถูก ไม่เหมือนพวกเรา**
		- มน ถามว่ามางานนี้ได้อย่างไร มีแต่คน VIP
		- ??????????????????
	- ข้อใด เป็นความรู้สึกของผู้ที่ไม่กล้าแสดงออก
		- หลังจากดูถูกเหยีดหยาม เกิดความรู้สึกผิด
		- เกิดความรู้สึกกังวลใจในขณะนั้น
		- เชื่อมั่น
		- เสียสละและมั่นใจ
	- เมย์ กำลังคุยกับอ้ำ เรารู้ว่าเธอกำลังกังวลใจเรื่องแฟน  สู้ต่อไปนะ แบบนี้เหมาะสมอย่างๆร
		- ทั่วไป
		- **เข้าใจคนอื่น**
		- รุนแรงเรื่อยๆ
		- เปลี่ยนสรรพนามเป็นฉัน
	- คุณครู ให้นักเรียนดูหนังเรื่องการอันทพารในโรงเรียน และร่วมกันอภิปรายเรื่องดังกล่าว เป็นการเหมาะสมอย่างไร
		- การซักซ้อมพฤติกรรม
		- การให้ข้อมูลย้อนกลับ
		- **การใช้ตัวแบบ**
		- การใช้จินตนาการ
	- จ้อใด ไม่จัดเป็นแรงเสริมทางบวก ในการฝึกพฤติกรรมที่เหหมาะสม
		- การปรบมือ เมื่อแสดงพฤติกรรมเหมาะสสม
		- **การนิ่งเฉย เมื่อไม่เหมาะสม**
		- การกล่าว
		- ชื่นชมเมื่อเหมาะสม
		- การตักเตือกเมื่อแสดงพฤติกรรมที่ไม่เหมาะสม
- # การพัฒนาบุคลิกภาพ
	- ข้อใด กล่าวถูกต้องเกี่ยวกับการยืนของผู้ชายที่สงางาม
		- ตาล ให้คำแนะนำ โดยการยืนตรงล้วงกระเป๋าเอก
		- **ป้อง รายงานปัญหา โดยยืนแยกขาเท่ากับไหล่ ใช้มือประกอบท่าทาง**
	- ข้อใดคือท่ายืนข้อผู้หญิง
		- ปลายเท้าซ้ายและขวาชิดกัน
		- ปลายเท้าซ้ายและขวาเสมอกัน แยกขาเล็กน้อย
		- **ปลายเท้าซ้ายที่เข็ม 10 และขวาที่ 12**
		- ปลายเท้า-;kที่เข็ม 10 และซ้ายที่ 12**
		-
	- บุคคลใดเดินได้ดีและถูกต้อง
		- เดินแกร่งแขน
	- บุคคลใดเดินกับผู้ใหญ่
		- **พาอาจารย์มาเยี่ยมห้องประชุมโดยเดินนำหน้า**
		- เดินตามหลังเล็กน้อย
		- เดินตีคู่
		- ไหว้ - เดินนำหน้าเล็กน้อย
	- ข้อใดกล่าวถูกต้อง เกี่ยวกับมารยาทการเดิน
		- เดินทางเท้า ให้เดินบนไหล่ซ้าย
		- เดินลงบันได ให้ระวัง โดยใช้มือจับราวและก้มมอง
		- เมื่อมีคนนั่ง ให้เดินโดยแบบย่องเท้า
		- **การเดินลงบันได ให้เดินชิดด้านใดด้านหนึ่ง เพื่อให้คนอื่นเดินสวนทางได้**
	- ข้อใดถูกต้องเกี่ยวกับการนั่ง
		- ท่าทางผ่อนคลาย
		- **หลังตรง หลังไม่พิง**
		- ลุกจากเก้าอี้โดยวางมือที่หัวเข่า
		- เดินจนขาชิดเก้าอี้ และบิดตัวเล็กน้อย
	-
	- # บทที่ 9
		-
	-