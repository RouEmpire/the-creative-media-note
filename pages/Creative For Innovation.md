...
- # Gestalt Principles
	...
	- Proximity ความใกล้ชิด
	  ...
	  แนวคิดคือคนชอบอะไรที่ดูเรียบง่ายและเหมาะสมพอดี ผู้คนมักจะมองว่าองค์ประกอบของแต่ละอย่างเป็นรูปร่างเดียว ซึ่งอยู่ในแบบที่เราจดจำมา เมื่อบางส่วนหายไป ดวงตาจะเติมเต็มช่องว่างเอง
	  หลักการ การปิด ระบุว่าเมื่อเราดูภาพที่ซับซ้อน เรามักจะมองหารูปแบบเดียวที่สามารถจดจำได้ เมื่อเห็นภาพที่ขาดไปสมองจะ เติมเต็มให้ 
	  Continuity ความต่อเนื่อง 
	  ...
	  หลักการของเกสตัลต์ ช่วยนำไปออกแบบในหลายด้านเช่น 
	  1. การออกแบบ UI
