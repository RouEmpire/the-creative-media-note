...
- # Creative Thinking
	...
	- ## Creative Thinking Improvement
		...
		- ### การ ((66cfff75-1156-4289-a30f-54871a303551)) เพื่อพัฒนา Creative Thinking
			...
			- #### ฝึกคิดเชิงบวก
				- **ฝึกคิดบวก คิดในแง่ดี คิดถึงความเป็นไปได้ที่ดี** การคิดแบบนี้จะทำให้เราค้นพบโอกาสความเป็นไปได้ในการสร้างสรรค์ผลงานโดยที่ไม่กลัวความคิดที่ไม่สร้างสรรค์ของคนอื่น และสุดท้ายก็จะทำให้เราสามารถมองข้ามขีดจำกัดของตัวเองไปได้
			- #### ฝึกคิดย้อนศร
				- **คิดสวนทางกับคนอื่น คิดตรงกันข้ามกับคนอื่น** จะทำให้เราได้ความคิดที่แปลกใหม่ และไม่เหมือนคนอื่น บางทีอาจนำมาปรับใช้กับงานอื่นๆ ได้
					- <samp><u>ตัวอย่าง</u>
					  การทําธุรกิจทีตรงกันข้ามจากคนอื่น เช่น ปกติรถเสียต้องพารถไปหาอู่แต่เมื่อ
					  คิดใหม่คือเอาอู่ไปหารถจึงทําให้เกิดธุรกิจบริการซ่อมรถฉุกเฉินขึ้นมามากมาย หรือเมื่อก่อนถ้าเราจะกินพิซซ่าเราจะต้องไปที่ร้านแต่เมื่อมีคนคิดย้อนศร คือ ส่งพิซซ่าไปหา ลูกค้าจึงเกิดธุรกิจ Home Delivery ขึ้นมามากมาย ปัจจุบนนี้เกิดธุรกิจอีกมากมาย เช่น การส่งดอกไม้ ร้านหนังสือ เป็นต้น</samp>
			- #### ฝึกคิดในสิ่งที่เป็นไปไม่ได้
				- **คิดว่าสิ่งที่เป็นไปไม่ได้ในอดีตสามารถเป็นไปได้ในตอนนี้** หรือไม่ก็เป็นไปได้ในอนาคต โดยที่ต้องใช้ความคิดสร้างสรรค์ของเราทำให้มันเป็นจริงขึ้นมา
			- #### ฝึกคิดบนหลักความเป็นจริง
				- **การคิดและวิเคราะห์ด้วยวิทยาศาสตร์** โดยมีรากฐานอยู่บนความเป็นจริง เช่น การใช้ตรรกะศาสตร์หรือสถิติศาสตร์ในการคิด จนเกิดเป็นความสร้างสรรค์ใหม่ๆ
			- #### การฝึกคิดแบบไขว้ / การคิดข้ามกล่องความรู้
				- **การเอาทุกความคิดที่มีมาผสมกัน** ทำให้เกิดความคิดใหม่ที่หลากหลายและสดใหม่ ขึ้นอยู่กับส่วนผสมว่าเราใส่อะไรลงไปบ้าง
		- ## ข้อควรปฏิบัติในการพัฒนา Creative Thinking
			- **อย่าคิดแง่ลบ**
				- ต้องคิดแง่บวกเสมอ จะช่วยให้เกิดความเชื่อมั่น และความคิดไม่ฝืด
			- **อย่าทำตามคนอื่น**
				- ต้องคิดเอง ลงมือเอง เชื่อมันในตน
			- **อย่าอยู่ในวงแคบ**
				- หาประสบการณ์ใหม่ๆ หาความรู้ใหม่ๆ เสมอ
			- **อย่ารักสบาย**
				- ไม่มีความคิดสร้างสรรค์ใดได้มาโดยง่าย ทุกความรู้
			- **อย่ากลัว**
				- ต้องกล้าเสี่ยง ท้าทายตลอดเวลา
			- **อย่าท้อใจ**
				- เมื่อเจอความผิดพลาด อย่าท้อใจ แต่จงเรียนรู้มันแทน
			- **อย่าทิ้งความคิดใดๆ**
				- จนกว่ามันจะถูกพิสูจน์ว่าไรประโยชน์ ทุกความคิดมีคุณค่าเสมอ
			- **อย่ากลัวการเผยแพร่ผลงาน**
				- ต้องกล้าเผยแพร่ผลงานที่แตกต่าง อย่าคิดว่าผลงานนั้นไม่เหมือนคนอื่น แต่ให้คิดว่ามันแหวกแนวแทน
				-