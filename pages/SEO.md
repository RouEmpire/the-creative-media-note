	...
	- **Sample Reports...**
		- Duplicate `<title>` or missing `<title>`
			...
			- ***Duplicate Pages are big NO NO***, if Google bots found this, you site page rank gonna be shit-
				...
				- Use **Canonical Tags** [](https://developers.google.com/search/docs/crawling-indexing/canonicalization?hl=th) | It is the Tags that user can click and surf your website normally, but will prevent Google's Bot from looking inside and rank it
				-
			-
			-
- # Technical SEO
